...
// HELPER: Ensures consistent theming (Fixes Dark/Light mode issues)
...
// 1. NFL SCOREBOARD SKELETON
export function NFLScoreboardSkeleton() {
  return (
      ...
      <div className="p-6 border-b flex flex-col items-center gap-6 relative" style={{ borderColor: "var(--widget-border)" }}>
         ...
         <div className="flex items-center justify-between w-full max-w-2xl mt-8">
            ...
            <div className="flex flex-col items-center justify-center gap-2">
               ...
               <Skeleton className="h-4 w-16 rounded-full mt-1" /> {/* Status (e.g. "4th Qtr") */}
            </div>
...
// 2. NFL H2H SKELETON
export function NFLH2HSkeleton() {
  return (
...
// 3. NFL STANDINGS SKELETON
export function NFLStandingsSkeleton() {
  return (
...
// 4. NFL ODDS SKELETON
export function NFLOddsSkeleton() {
  return (
        ...
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className={`p-3 ${cardClass}`} style={cardStyle}>
             ...
             <div className="flex gap-2">
                {[1, 2].map((j) => ( /* 2-way betting is common in NFL (Moneyline) */
                   <div 
                     key={j} 
