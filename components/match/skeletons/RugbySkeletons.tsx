...
// 1. RUGBY SCOREBOARD SKELETON
export function RugbyScoreboardSkeleton() {
  return (
         ...
         <div className="flex items-center justify-between w-full max-w-2xl mt-8">
            ...
            <div className="flex flex-col items-center justify-center gap-2">
               ...
               <div className="flex gap-1 mt-1">
                  <Skeleton className="h-4 w-4" /> {/* H1 */}
                  <Skeleton className="h-4 w-4" /> {/* H2 */}
               </div>
...
// 2. RUGBY H2H SKELETON
export function RugbyH2HSkeleton() {
  return (
...
// 3. RUGBY STANDINGS SKELETON
export function RugbyStandingsSkeleton() {
  return (
    <div className="p-4 space-y-8">
      {[1, 2].map((g) => (
        <div key={g} className="space-y-4">
           <Skeleton className="h-6 w-40" /> {/* Group/Stage Name */}
...
// 4. RUGBY ODDS SKELETON
export function RugbyOddsSkeleton() {
  return (
