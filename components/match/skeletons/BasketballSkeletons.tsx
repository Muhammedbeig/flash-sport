...
// HELPER: Matches the Football fix exactly
...
// 1. BASKETBALL SCOREBOARD SKELETON
export function BasketballScoreboardSkeleton() {
  return (
    <div className={cardClass} style={cardStyle}>
      <div className="p-6 border-b flex flex-col items-center gap-6 relative" style={{ borderColor: "var(--widget-border)" }}>
         ...
         <div className="flex items-center justify-between w-full max-w-2xl mt-8">
            ...
            {/* Score Center (Quarters) */}
            <div className="flex flex-col items-center justify-center gap-2">
               <Skeleton className="h-10 w-24 rounded-lg" /> {/* Total Score */}
               <div className="flex gap-1 mt-1">
                  <Skeleton className="h-4 w-4" /> {/* Q1 */}
                  <Skeleton className="h-4 w-4" /> {/* Q2 */}
                  <Skeleton className="h-4 w-4" /> {/* Q3 */}
                  <Skeleton className="h-4 w-4" /> {/* Q4 */}
               </div>
               <Skeleton className="h-4 w-12 rounded-full mt-1" /> {/* Status */}
            </div>
...
// 2. H2H SKELETON
export function BasketballH2HSkeleton() {
  return (
...
export function BasketballStandingsSkeleton() {
  return (
    <div className="p-4 space-y-8">
      {[1, 2].map((g) => (
        <div key={g} className="space-y-4">
           <Skeleton className="h-6 w-40" /> {/* Conference Name */}
...
// 4. ODDS SKELETON
export function BasketballOddsSkeleton() {
  return (
    <div className="p-4 space-y-6">
      <Skeleton className="h-6 w-48 mb-4" />
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className={`p-4 ${cardClass}`} style={cardStyle}>
