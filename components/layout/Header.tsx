      ...
      <div className="hidden lg:flex items-center h-16 px-6 justify-between">
        <div className="flex items-center">
          ...
          <nav className="flex items-center gap-2">
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all
                    ${
                      isActive
                        ...
                        : "text-secondary hover:bg-gray-100 dark:hover:bg-slate-800 hover:text-primary"
                    }`}
                >
            ...
            >
              <button
                className={`flex items-center gap-1 px-4 py-2.5 rounded-lg text-sm font-semibold
                  ${
                  ...
                  <div className="theme-bg theme-border border rounded-xl shadow-xl overflow-hidden py-1">
                    {desktopHidden.map((sport) => (
                      <Link
                        ...
                        className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-secondary hover:bg-gray-100 dark:hover:bg-slate-700 hover:text-primary"
                      >
        ...
        <button
          onClick={toggleTheme}
          className="p-2 text-secondary hover:bg-gray-100 dark:hover:bg-slate-800 rounded-full transition-colors"
          title="Toggle Theme"
        >
      ...
      <div className="lg:hidden">
        <div className="flex items-center justify-between px-4 h-14 theme-bg theme-border border-b">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={toggleTheme}
              className="p-2 text-secondary active:bg-gray-100 dark:active:bg-slate-800 rounded-md"
            >
            ...
            <button
              onClick={onMenuClick}
              className="p-2 -mr-2 text-secondary active:bg-gray-100 dark:active:bg-slate-800 rounded-md"
            >
              <Menu size={28} />
            </button>
          </div>
          ...
          <div className="absolute top-full left-0 w-full theme-bg theme-border border-t shadow-xl py-2 grid grid-cols-2 gap-2 px-4 animate-in slide-in-from-top-2 fade-in duration-200">
            {DESKTOP_SPORTS.filter(
              ...
              <Link
                ...
                href={`/?sport=${sport.id}`}
                onClick={() => setMobileMoreOpen(false)}
                className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 text-sm font-medium text-secondary hover:text-primary"
              >
