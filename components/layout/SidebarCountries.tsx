...
type CountryData = { name: string; code: string | null; flag: string | null; leagues: League[]; };

export default function SidebarCountries({ currentSport, onLinkClick }: { currentSport: string; onLinkClick?: () => void; }) {
          ...
          <div key={country.name} className="border-b theme-border last:border-0">
            ...
            >
              <div className="flex items-center gap-3 overflow-hidden">
                {country.flag ? (
                  <img src={country.flag} alt={country.name} className="w-4 h-4 object-contain shrink-0" />
                ) : (
