...
export default async function SportsLeagueTabPage({
  params,
}: {
  params: Promise<{ sport: string; tab: string; leagueId: string }>;
}) {
  ...
  return (
    <div className="min-h-screen theme-bg p-4 md:p-6 transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        {/* Force remount so league switch + tab switch never reuses old state */}
        <GameWidget
